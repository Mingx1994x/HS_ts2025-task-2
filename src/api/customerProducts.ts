...
export const getProductsAll=():Promise<AxiosResponse<TGetProductsAllResponse>>=>(hexStoreApi.get(`/v2/api/${VITE_API_PATH}/products/all`))
...
export const getProductById=(id:string):Promise<AxiosResponse<TGetProductByIdResponse>>=>(hexStoreApi.get(`/v2/api/${VITE_API_PATH}/product/${id}`))
